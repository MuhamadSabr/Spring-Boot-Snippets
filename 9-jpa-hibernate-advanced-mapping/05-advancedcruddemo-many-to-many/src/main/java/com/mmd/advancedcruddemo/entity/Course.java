...
public class Course {
	...
	//Add many-to-many relationship with Student entity
	...
	public Course(){reviews = new ArrayList<>(); students = new ArrayList<>();}
	...
	//Add helper method to add a student to a course
