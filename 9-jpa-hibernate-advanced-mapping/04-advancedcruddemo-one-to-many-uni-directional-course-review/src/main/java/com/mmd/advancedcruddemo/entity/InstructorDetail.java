...
//    private Instructor instructor;
    ...
    //instructorDetail is the name of the field that represents this side(inverse) in the owning side, which it must be.
    @OneToOne(targetEntity = Instructor.class, mappedBy = "instructorDetail", cascade = {CascadeType.DETACH, CascadeType.MERGE, CascadeType.PERSIST, CascadeType.REFRESH})
    @JoinColumn(name = "instructor_detail_id", referencedColumnName = "id")//Again name is FK in owning side, referencedColumnName is primary key of inverse side.
    private Instructor instructor;
